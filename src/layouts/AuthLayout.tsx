  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center p-4">
      <Link to="/" className="flex items-center gap-2 mb-8">
        ...
        <span className="font-bold text-2xl tracking-tight text-slate-900 dark:text-white">SPARK</span>
      </Link>
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">{subtitle}</p>
        </div>
        {children}
      </div>
